...
if ((t->Right) != NULL) r = deep(t->Right);
if ((t->Left) != NULL) l = deep(t->Left);
if (r > l)
...
if ((t->Left) != NULL) return(insert(t->Left, value));
